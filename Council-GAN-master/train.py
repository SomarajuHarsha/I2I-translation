...
shutil.copy(opts.config, os.path.join(config_backup_folder, ('config_backup_' + str(datetime.datetime.now())[:19].replace(':', '') + '.yaml').replace(' ', '_')))  # copy config file to output folder
